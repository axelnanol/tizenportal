(function() {
    ...
    var UI = {
        ...
        init: function() {
            ...
            d.innerHTML = '<div style="padding:15px;background:#222;color:#FFD700;font-weight:bold">TizenPortal 045</div>' +
    ...
    var ready = function() { UI.init(); Input.init(); if(loaded) UI.toast("TizenPortal 045"); else UI.toast("No Config"); };
