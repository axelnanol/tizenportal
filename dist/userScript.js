(function() {
    ...
    var UI = {
        ...
        init: function() {
            ...
            d.innerHTML = '<div style="padding:15px;background:#222;color:#FFD700;font-weight:bold">TizenPortal 024</div><div style="flex-shrink:0;overflow-y:auto;max-height:50%" id="tp-l"></div><div id="tp-c" tabindex="0"></div>';
    ...
    var ready = function() { UI.init(); Input.init(); if(loaded) UI.toast("TizenPortal 024"); else UI.toast("No Config"); };
