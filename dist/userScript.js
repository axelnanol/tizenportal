(function() {
    ...
    var UI = {
        ...
        nav: function(d) {
            ...
            if(this.idx < 0) this.idx = this.items.length - 1;
    ...
    var Input = {
        ...
        init: function() {
            ...
            var regInterval = setInterval(function() {
                if (typeof tizen !== 'undefined' && tizen.tvinputdevice) {
                    ["ColorF0Red","ColorF1Green","ColorF2Yellow","ColorF3Blue","MediaPlay","MediaPause"].forEach(function(k){
        ...
        toggleMouse: function() {
            ...
            if (!this.cursor) {
                ...
                c.style.cssText='position:fixed;width:20px;height:20px;background:red;border:2px solid #fff;border-radius:50%;z-index:2147483647;pointer-events:none;display:none';
                document.body.appendChild(c);
                this.cursor = c;
            }
            this.cursor.style.display = this.mouse ? 'block' : 'none';
